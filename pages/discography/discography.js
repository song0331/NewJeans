...
function bg() {
  if (pageCnt == 0) {
    $(".discography-bg").css(
      "background-image",
      "url(https://song0331.github.io/newjeans/discography/0.jpg)"
    );
    ...
    $(".discography-bg").css(
      "background-image",
      "url(https://song0331.github.io/newjeans/discography/1.jpg)"
    );
    ...
    $(".discography-bg").css(
      "background-image",
      "url(https://song0331.github.io/newjeans/discography/2.jpg)"
    );
    ...
    $(".discography-bg").css(
      "background-image",
      "url(https://song0331.github.io/newjeans/discography/3.jpg)"
    );
