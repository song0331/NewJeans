import"./index-DXZE7Dtf.js";import"./main-BOxjpGdl.js";import{s}from"./setTitle-DhMamm5E.js";s("Gallery");let a=!1;$(".navbar-btn").click(function(){$(".navbar").toggleClass("open",!a),$(".navbar").toggleClass("close",a),a=!a});let g=0;$(document).on("click",".img",function(t){$(t.target).toggleClass("full"),t.target.dataset.onoff==1?t.target.dataset.onoff="0":(g++,t.target.dataset.onoff="1",$(t.target).css("z-index",`${g}`))});function l(t){$.get(`/NewJeans/data/${t}.json`).done(function(o){for(let i=0;i<o.length;i++){let e=`
                  <div class="img-box ${t}">
